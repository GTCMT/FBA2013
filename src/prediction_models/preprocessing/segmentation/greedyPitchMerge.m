...
pitch_difference_cents = [];  % Index corresponds to smaller index in note-pair.
for(note_idx = 1:num_notes - 1)
  ...
  pitch_difference_cents = [pitch_difference_cents; cur_pitch_difference];
end
